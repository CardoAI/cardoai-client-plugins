---
title: Commercial — Ecommerce Finance
tier: sub:commercial/ecommerce-finance
kpi_count: 17
inherits_from:
  - commercial/common/kpis
---

# Commercial — Ecommerce Finance
...
Weight % = Current Principal Balance / Total Current Principal Balance for the Reporting Date
```
...
```
Group by: Reporting Date, Original Balance
