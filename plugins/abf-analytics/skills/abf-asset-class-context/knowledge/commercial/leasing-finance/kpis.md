---
title: Commercial — Leasing Finance
tier: sub:commercial/leasing-finance
kpi_count: 14
inherits_from:
...
Breaks the pool by lease structure (Finance Lease vs. Operating Lease). Determines whether residual value risk sits with the lessor or lessee and affects how cash flows and balloon payments are modelled.
...
Open Loans = Count of Loan IDs where Loan is not Closed
UPB = Sum of UPB
Residual / Balloon Amount = Sum of Residual Value Amounts
```
